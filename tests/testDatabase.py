...
from tests.arguments import REPO_DOWNLOAD_DIR, GHTORRENT_DB_STRING, DB_STRING, GH_TOKEN
...
class TestDatabase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.jiradb = JIRADB(GHTORRENT_DB_STRING, ghtoken=GH_TOKEN, dbstring=DB_STRING)
