...
Hortonworks was the only organization that contributed to all of these projects during \timeperiod, but several of the organizations with the highest centralities contributed to many of them. For example, Confluent and IBM each contributed to five of the eight projects, and Cloudera and Yahoo each contributed to four.