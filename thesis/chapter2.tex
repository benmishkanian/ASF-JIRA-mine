...
Due to technical limitations in some of the external tools used to obtain project and contributor data, three different databases were required. The following subsections describe the purpose and schema of these databases.
...
% TODO: insert schema diagram
\subsection{CVSAnalY Database}
