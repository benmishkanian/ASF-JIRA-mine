...
class JIRADB(object):
            ...
            if domain is not None:
                ...
                if domain == 'apache.org' or domain.endswith('.local') or domain.endswith('.(none)') or domain.endswith('.internal'):
                    ...
                    if not usingPersonalEmail:
                        usingPersonalEmail = self.isEmailDomainAdmin(contributorEmail, domain, person.displayName)
            else:
    ...
    def isEmailDomainAdmin(self, contributorEmail, domain, contributorName):
        """
